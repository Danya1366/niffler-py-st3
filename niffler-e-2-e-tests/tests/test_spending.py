...
class TestSpends:
    ...
    def test_new_spending_with_yesterday_date(self, envs, spending_page, main_page):
    ...
    @Pages.open_spending_page
    @TestData.spends(TestSpendings.TestDataSpend)
    def test_delete_all_spendings(self, spends, spending_page, main_page):
    ...
    @Pages.main_page
    @TestData.spends(TestSpendings.TestDataSpend)
    def test_total_of_spend(self, page, spends, envs, spending_page, main_page):
        page.reload()
