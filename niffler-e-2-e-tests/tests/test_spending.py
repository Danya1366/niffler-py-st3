...
@Pages.spending_page
def test_new_spending_with_yesterday_date(page, frontend_url, spending_page):
    fake = Faker("ru_RU")
...
def test_update_spending(page, category, spends, frontend_url, spending_page):
...
def test_delete_all_spendings(page, category, spends, spending_page):
    amount = "200.01"
    category = "QA_GURU"
